...
export default function CoursePage() {
  ...
  const [courseWithCompletion, setCourseWithCompletion] =
    useState<CourseWithCompletionChapters | null>(null);
  ...
  const calculateProgress = useCallback(() => {
    ...
    const totalLessons = courseWithCompletion.chapters.reduce(
      (sum, chapter) => sum + chapter.lessons.length,
      0
    );
    const completedLessons = courseWithCompletion.chapters.reduce(
      (sum, chapter) =>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {isCreator && (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleStartEditing(chapter.id, chapter.title)
                            }
                          >
              ...
              {selectedLesson ? (
                <div className="bg-white shadow rounded-lg p-6 mb-6">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                      onClick={() => {
                        const chapter = courseWithCompletion?.chapters.find(
                          (c) =>
                            c.lessons.some((l) => l.id === selectedLesson.id)
                        );
                        if (chapter) {
                  ...
                  <div className="mt-4">
                    ...
                    {isCreator ? (
                      <>
                        ...
                        />
                        <Button
                          onClick={handleLessonContentSave}
                          className="bg-black hover:bg-gray-800 text-white"
                        >
                          Save Content
                        </Button>
